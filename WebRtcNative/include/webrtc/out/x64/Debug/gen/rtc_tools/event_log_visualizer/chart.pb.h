...
class ChartStyle : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.analytics.ChartStyle) */ {
 public:
  ...
  inline ChartStyle* New() const PROTOBUF_FINAL { return New(NULL); }

  ChartStyle* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class ChartCollection : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.analytics.ChartCollection) */ {
 public:
  ...
  inline ChartCollection* New() const PROTOBUF_FINAL { return New(NULL); }

  ChartCollection* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
