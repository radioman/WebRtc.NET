...
class AlrState : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:webrtc.rtclog.AlrState) */ {
 public:
  ...
  inline AlrState* New() const PROTOBUF_FINAL { return New(NULL); }

  AlrState* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CheckTypeAndMergeFrom(const ::google::protobuf::MessageLite& from)
    PROTOBUF_FINAL;
...
inline void Event::set_allocated_alr_state(::webrtc::rtclog::AlrState* alr_state) {
  clear_subtype();
  if (alr_state) {
    set_has_alr_state();
