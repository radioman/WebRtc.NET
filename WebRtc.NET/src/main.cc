...
#pragma comment(lib,"boringssl.dll.lib")
#pragma comment(lib,"libyuv.lib")
#pragma comment(lib,"protobuf_lite.dll.lib")
...
#pragma comment(lib,"protobuf_full_do_not_use.lib")
...
#pragma comment(lib,"rtc_sound.lib")
